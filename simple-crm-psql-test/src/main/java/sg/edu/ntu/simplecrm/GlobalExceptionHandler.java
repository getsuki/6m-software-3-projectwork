...
public class GlobalExceptionHandler {
  ...
  // handleplayerNotFoundExcetion(playerNotFoundException ex) {
  // ErrorResponse errorResponse = new ErrorResponse(ex.getMessage(),
  // LocalDateTime.now());
  // return new ResponseEntity<>(errorResponse, HttpStatus.NOT_FOUND);
  // }

  // @ExceptionHandler(KeyStatisticsNotFoundException.class)
  // public ResponseEntity<ErrorResponse>
  // handleKeyStatisticsNotFoundExcetion(KeyStatisticsNotFoundException ex) {
  // ErrorResponse errorResponse = new ErrorResponse(ex.getMessage(),
  // LocalDateTime.now());
  // return new ResponseEntity<>(errorResponse, HttpStatus.NOT_FOUND);
  // }
  ...
  @ExceptionHandler({ KeyStatisticsNotFoundException.class, playerNotFoundException.class })
